...
public class MolangMath extends MolangNamespace {
    ...
    public MolangMath() {
        ...
        registerFunction("random", 2, NUM_CHECK, (l, ctx) -> MolangResult.ofFloat(MathHelper.nextFloat(new Random(), l.get(0).getFloat(), l.get(1).getFloat())));
        registerFunction("random_integer", 2, NUM_CHECK, (l, ctx) -> MolangResult.ofFloat(MathHelper.nextInt(new Random(), (int)l.get(0).getFloat(), (int)l.get(1).getFloat())));
        registerFunction("die_roll", 3, NUM_CHECK, (l, ctx) -> {
            ...
            for(int i = 0; i < sums; i++)
                value += MathHelper.nextFloat(r, min, max);
        ...
        registerFunction("die_roll_integer", 3, NUM_CHECK, (l, ctx) -> {
            ...
            int value = 0;
            for(int i = 0; i < sums; i++)
                value += MathHelper.nextInt(r, min, max);
            return MolangResult.ofFloat(value);
        });
